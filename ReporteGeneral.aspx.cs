...
namespace ProyectoFinal_IngSoftware
{
    public partial class ReporteGeneral : System.Web.UI.Page
    {
        ...
        private static List<UserStory> ObtenerListaUSActualizar(List<string> backlogIds, List<string> todoIds, List<string> wipIds, List<string> doneIds)
        {
            List<UserStory> allUSActualizar = new List<UserStory>();

            allUSActualizar.AddRange(ObtenerUSActualizar(backlogIds, "BACKLOG"));
            allUSActualizar.AddRange(ObtenerUSActualizar(todoIds, "TODO"));
            allUSActualizar.AddRange(ObtenerUSActualizar(wipIds, "WIP"));
            allUSActualizar.AddRange(ObtenerUSActualizar(doneIds, "DONE"));
        ...
        private static void ActualizarUserStories(List<UserStory> allUSActualizar)
        {
            ...
            {
                ModificarEstadoID(usActualizar.USId, usActualizar.Estado);
            }
        }
        ...
        {
            clm.InnerHtml = clm.InnerHtml + "<div id=\"" + us.Estado.ToUpper() + us.USId + "\" class=\"card portlet\" style=\"width: 15rem;\"><div class=\"card-body\"><h5 class=\"card-title portlet-header\">" + us.Nombre + "</h5>";
            clm.InnerHtml = clm.InnerHtml + "<h6 class=\"card-subtitle mb-2 text-muted\">Prioridad: " + us.Prioridad + "</h6>";
            clm.InnerHtml = clm.InnerHtml + "<textarea class=\"card-text form-control\" id=\"cardTxtArea" + us.USId + "\" rows=\"3\">" + us.Descripcion + "</textarea>";
